...
#include <mcl3d_tda_ros/Point.h>
#include <mcl3d_tda_ros/Pose.h>
#include <mcl3d_tda_ros/Particle.h>
...
public:
    ...
    void initializeParticlesFromPoses(std::vector<Pose> candidatePoses, Pose initialNoise);
    ...
    void applyExternalLikelihoods(std::vector<double> likelihoods);
